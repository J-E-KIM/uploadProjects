...
<body>
	<div class="slide" style="width: 1000px; height: 600px; padding: 0 0 0 0; ">
  <ul class="panel">
    <li>
    	<img style="width: 1000px; height: 600px;" 
						alt="one" src="./resources/img/main1.PNG">
    </li>
    <li>
    	<img style="width: 1000px; height: 600px;" 
						alt="one" src="./resources/img/main2.PNG">
    </li>
    <li>
    	<img style="width: 1000px; height: 600px;" 
						alt="one" src="./resources/img/main3.PNG">
    </li>
  </ul>
  <ul class="dot">
